...
namespace JokesPracticeDocker.Controllers
{
    ...
    public class JokesController : ControllerBase
    {
        ...
        // GET /jokes - список шуток (опционально ?category=...)
        [HttpGet("jokes")]
        ...
        // GET /jokes/random - случайна€ шутка (опционально ?category=...)
        ...
        // POST /jokes/{id}/vote - голосование up/down
